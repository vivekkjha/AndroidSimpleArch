...
import com.mds.android.BuildConfig;

import java.lang.reflect.Field;

/**
 * Created by vivekjha on 25/01/16.
 */
public class WrapContentLayoutManager extends android.support.v7.widget.LinearLayoutManager{
    ...
    @SuppressWarnings("UnusedDeclaration")
    public WrapContentLayoutManager(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public WrapContentLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
